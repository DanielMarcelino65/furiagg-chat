      ...
      <Wrapper>
        <div className="flex items-center justify-center md:justify-start w-full min-h-screen">
          <div className="flex flex-col mb-5 md:mb-0 gap-2 items-center md:items-start justify-center w-fit h-full">
            <h1 className="text-[32px] md:text-[48px] lg:text-[64px] font-bebas-neue font-bold text-[#E7E7E7]">
              CONVERSE COM A FÚRIA
            </h1>
            <p className="text-[16px] md:text-[20px] lg:text-[24px] text-center font-bebas-neue font-light text-[#E7E7E7]">
          ...
          <Image
            className="z-10 absolute bottom-0 right-2.5 w-[600px] md:h-[600px] lg:w-[800px] lg:h-[800px]"
            src={FallenPhoto}
